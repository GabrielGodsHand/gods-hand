...
export default function PetitionsClient({
  organization,
  petitions,
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="mb-12">
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 p-8 shadow-2xl text-center">
            ...
            <p className="text-gray-700 text-lg font-['Cinzel']">
              Track the status of your fund requests for{" "}
        ...
        {petitions.length === 0 ? (
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 p-12 shadow-2xl text-center">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-['Cinzel']">
              No Petitions Yet
            </h3>
            <p className="text-gray-700 mb-8 text-lg font-['Cinzel']">
              You haven&apos;t submitted any fund petitions yet. Visit the
          ...
          <div className="space-y-8">
            {petitions.map((petition) => (
              <div
                key={petition.id}
                className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 p-8 shadow-2xl hover:shadow-3xl transition-all duration-300"
              >
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h3 className="text-2xl font-semibold text-gray-900 mb-3 font-['Cinzel']">
                      {petition.petition_title}
                    </h3>
                    <div className="flex items-center space-x-4 text-sm text-gray-700">
                      <span className="font-['Cinzel']">
                        Fund: {petition.fund_vaults.vault_name}
                      </span>
                      <span>•</span>
                      <span className="font-['Cinzel']">
                        Submitted:{" "}
                  ...
                  <span
                    className={`inline-flex px-4 py-2 text-sm font-semibold rounded-full font-['Cinzel'] ${getStatusColor(
                      petition.status
                    )}`}
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                  <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 border border-white/30">
                    <h4 className="text-xs font-semibold text-gray-600 mb-2 font-['Cinzel']">
                      Requested Amount
                    </h4>
                    <p className="text-xl font-bold text-gray-900 font-['Cinzel']">
                      ${petition.requested_amount.toLocaleString()}
                    </p>
                  </div>
                  <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 border border-white/30">
                    <h4 className="text-xs font-semibold text-gray-600 mb-2 font-['Cinzel']">
                  ...
                  <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 border border-white/30">
                    ...
                    <p className="text-xl font-bold text-gray-900 font-['Cinzel']">
                      {petition.beneficiaries_count.toLocaleString()}
                    </p>
                  </div>
                  <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 border border-white/30">
                    <h4 className="text-xs font-semibold text-gray-600 mb-2 font-['Cinzel']">
                    ...
                    <p className="text-xl font-bold text-gray-900 font-['Cinzel']">
                      {petition.project_timeline}
                    </p>
                  </div>
                </div>

                <div className="mb-6">
                  <h4 className="text-base font-semibold text-gray-800 mb-3 font-['Cinzel']">
                    Project Description
                  </h4>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-700 font-['Cinzel'] leading-relaxed">
                    {petition.expected_impact}
                  </p>
                </div>

                {petition.approved_amount && (
                  <div className="bg-green-500/10 backdrop-blur-sm border border-green-500/20 rounded-2xl p-4 mb-6">
                    <h4 className="text-sm font-semibold text-green-800 mb-2 font-['Cinzel']">
                      Approved Amount
                    </h4>
                    <p className="text-2xl font-bold text-green-900 font-['Cinzel']">
                      ${petition.approved_amount.toLocaleString()}
                    </p>
                  </div>
                )}
                ...
                {petition.funded_amount && (
                  <div className="bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-4 mb-6">
                    <h4 className="text-sm font-semibold text-blue-800 mb-2 font-['Cinzel']">
                      Funded Amount
                    </h4>
                    <p className="text-2xl font-bold text-blue-900 font-['Cinzel']">
                      ${petition.funded_amount.toLocaleString()}
                    </p>
                  </div>
                )}
                ...
                {petition.review_notes && (
                  <div className="bg-yellow-500/10 backdrop-blur-sm border border-yellow-500/20 rounded-2xl p-4">
                    <h4 className="text-sm font-semibold text-yellow-800 mb-2 font-['Cinzel']">
                      Review Notes
                    </h4>
