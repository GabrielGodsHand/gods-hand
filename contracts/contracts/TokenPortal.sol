...
// Messaging
import {IRegistry} from "./packages/governance/interfaces/IRegistry.sol";
import {IInbox} from "./packages/core/interfaces/messagebridge/IInbox.sol";
import {IOutbox} from "./packages/core/interfaces/messagebridge/IOutbox.sol";
import {IRollup} from "./packages/core/interfaces/IRollup.sol";
import {DataStructures} from "./packages/core/libraries/DataStructures.sol";
// docs:start:content_hash_sol_import
import {Hash} from "./packages/core/libraries/crypto/Hash.sol";
...
contract TokenPortal {
    ...
    function depositToAztecPublic(
        ...
        returns (
            bytes32,
            uint256 // docs:end:deposit_public
        )
    {
        // Preamble
    ...
    function depositToAztecPrivate(
        ...
        returns (
            bytes32,
            uint256 // docs:end:deposit_private
        )
    {
        // Preamble
        DataStructures.L2Actor memory actor = DataStructures.L2Actor(
