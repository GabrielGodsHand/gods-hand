...
import {SubmitEpochRootProofArgs, PublicInputArgs} from "../../interfaces/IRollup.sol";
import {Timestamp, TimeLib} from "../TimeLib.sol";
...
library ExtRollupLib {
    ...
    function getEpochProofPublicInputs(
        ...
        return
            EpochProofLib.getEpochProofPublicInputs(
                _start,
                _end,
                _args,
                _fees,
