...
library AddressSnapshotLib {
    ...
    function remove(
        ...
        address _address = address(
            _self.checkpoints[_index].latest().toUint160()
        );
    ...
    function _remove(
        ...
        address lastValidator = address(
            _self.checkpoints[lastIndex].latest().toUint160()
        );
        ...
        if (lastIndex == _index) {
            ...
            _self.addressToIndex[lastValidator] = Index({
                exists: true,
                index: _index.toUint224()
            });
            _self.checkpoints[_index].push(
                key,
                uint160(lastValidator).toUint224()
            );
        }
    ...
    function at(
        ...
        return
            getAddressFromIndexAtTimestamp(
                _self,
                _index,
    ...
    function getAddressFromIndexAtTimestamp(
        ...
        require(
            _index < size,
            AddressSnapshotLib__IndexOutOfBounds(_index, size)
        );
