...
import {User, UserLib} from "./UserLib.sol";
...
library DelegationLib {
    ...
    function increaseBalance(
        ...
        moveVotingPower(
            _self,
            address(0),
            instance.attesterData[_attester].delegatee,
            _amount
        );
    ...
    function usePower(
        ...
        require(
            ...
            Errors.Delegation__InsufficientPower(
                _delegatee,
                powerAt,
                powerUsed + _amount
            )
    ...
    function moveVotingPower(
        ...
        if (_from != address(0)) {
            (uint256 oldValue, uint256 newValue) = _self
                .delegateeData[_from]
                .votingPower
                .sub(_amount);
